...
# Hermion
**Open-Source, Private, Ultra-Fast Voice Keyboard for macOS**

*Dictate and speak your thoughts directly into any application with zero cloud latency.*
...
[![Privacy](https://img.shields.io/badge/Privacy-100%25%20On--Device-success?style=for-the-badge)](https://github.com/rimraf-adi/hermion)
...
- **Dynamic Recording Island**: Smoothly widens (360px) to display sound-reactive equalizer waves, real-time live subtitle streaming, and subtle theme accents.
...
### DSP Noise Reduction & Live Dry-Run
...
- **Global `Cmd+Q` & Standard Shortcuts**: Native application menu with standard Mac keybindings.
...
│ 4. Press [Enter] or tap [Right Shift] to Paste (Cmd+V)      │
└─────────────────────────────────────────────────────────────┘
```
...
| **`Cmd+Q`** | **Quit App** | Cleanly terminates all background processes. |
| **`Cmd+,`** | **Open Settings** | Opens the Hermion preferences panel. |

*Alternative hotkeys available in Settings: `Double Shift`, `Shift + Space`, `Option + Space`, `Control + Space`.*
